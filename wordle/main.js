...
function lang(){
    const lang = document.querySelector('input[name="langChoose"]:checked').value;
    if(lang=="cs"){
        language = "cs";
        wordsArr=allWordsArr;
        document.querySelector("#rada").style.display = "block";
        document.querySelector("#wordle").textContent += " v češtině";
    }
    else{
        language="en"
        wordsArr=enWordsArr;
        document.querySelector("#wordle").textContent += " in english";
    }
    state.secret = wordsArr[Math.floor(Math.random()*wordsArr.length)]
}

function play(){
    document.querySelector("#endTxt").textContent = "";
    document.querySelector(".language-choose").style.display = "None";
...
async function revealWord(guess) {
    ...
    if (isWinner) {
        isPlaying=false;
        if(language=="cs"){
            endTxt.textContent="Vyhrál jsi!";
        }
        else{
            endTxt.textContent="You won!";
        }
        // window.alert("You won!");
    } else if (isGameOver) {
        if(language=="cs"){
            endTxt.textContent=`Prohrál jsi. Slovo bylo ${state.secret}.`;
        }
        else{
            endTxt.textContent=`You lost. The word was ${state.secret}.`;
        }
